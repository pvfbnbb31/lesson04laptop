"""
Django settings for lesson04laptop project.
...
#
#  heroku config:set DJANGO_SECRET_KEY='ur%v*y*roa$b3j2xa=t1u_nlzgl&ns-7k$r3o*k2f=&ncqw^+2'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'ur%v*y*roa$b3j2xa=t1u_nlzgl&ns-7k$r3o*k2f=&ncqw^+2'
...
ROOT_URLCONF = 'lesson04laptop.urls'

# WSGI configuration
# See https://docs.djangoproject.com/en/1.7/howto/deployment/wsgi/
WSGI_APPLICATION = 'lesson04laptop.wsgi.application'

# Database
# https://docs.djangoproject.com/en/1.7/ref/settings/#databases
# Parse database configuration from DATABASE_URL using dj-database-url
# if the environment variable is not defined then default to lesson04laptop_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'lesson04laptop_db.sqlite3')),
}
